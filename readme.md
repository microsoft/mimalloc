...
Latest release   : `v3.4.0`  (2026-07-14) recommended.  
Latest v2 release: `v2.4.0`  (2026-07-14) stable.  
...
### Releases
* 2026-07-14, `v1.9.11`, `v2.4.0`, `v3.4.0`: various bug and security fixes through LLM audit (by @Zoxc). 
  ...
  use TLS slots 126/127 on macOS (v3), and other small fixes.
