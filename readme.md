...
Latest release:`v1.6.4` (2020-07-27).
...
* 2020-07-27, `v1.6.4`: stable release 1.6: improved error recovery in low-memory situations,
  support for IllumOS and Haiku, NUMA support for Vista/XP, ubsan support.
